const project = {
  "slug": "agent-escrow-protocol",
  "title": "Agent Escrow Protocol",
  "version": "1.0.0",
  "tagline": "Human approval queues for costly, risky, or irreversible agent actions.",
  "problem": "Agents need autonomy, but high-impact actions still require explainable intent, bounded authority, and auditable approval.",
  "solution": "An approval packet validator that checks action intent, risk class, budget, rollback plan, approver identity, and execution window.",
  "required": [
    "action.kind",
    "action.system",
    "action.reversible",
